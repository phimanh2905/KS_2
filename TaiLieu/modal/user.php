    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
               {!! Form::open(['class' => 'form-horizontal', 'method' => 'POST', 'route' => ['user.update',$user->id]]) !!}
               <div>
            ...
            <div>
                ...
                <input type="text" name="MatKhau" class="form-control" id="MatKhau">
            </div>
            <div>
                <label for="label">Loại người dùng</label>
                <input type="text" name="LoaiNguoiDung" class="form-control" id="LoaiNguoiDung">
            </div>
